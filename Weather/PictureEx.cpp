		...
		if (m_hDispMemDC && (m_arrFrames[m_nCurrFrame].m_nDisposal == 3))
		{
			...
			*/
			::TransparentBlt(m_hMemDC,
				m_arrFrames[m_nCurrFrame].m_frameOffset.cx,
				m_arrFrames[m_nCurrFrame].m_frameOffset.cy,
				m_arrFrames[m_nCurrFrame].m_frameSize.cx / 5 * 3,
				m_arrFrames[m_nCurrFrame].m_frameSize.cy / 5 * 3,
				m_hDispMemDC,
				0,
				0,
				m_arrFrames[m_nCurrFrame].m_frameSize.cx,
	...
	else
	{
		...
		*/
		::TransparentBlt(dc.m_hDC,
			0,
			0,
			m_PictureSize.cx / 5 * 3,
			m_PictureSize.cy / 5 * 3,
			m_hMemDC,
			0,
			0,
			m_PictureSize.cx,
